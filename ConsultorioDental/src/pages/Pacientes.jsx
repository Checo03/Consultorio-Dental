          ...
          <div className="pacientes-modal-form">
            ...
            <div className="pacientes-patient-info">
              <div className="pacientes-patient-details">
                <span className="pacientes-detail-item">
                  <strong>Edad:</strong> {calcularEdad(selectedPaciente.FechaNacimiento)} años
                </span>
                <span className="pacientes-detail-item">
                  <strong>Género:</strong> {selectedPaciente.Genero === 1 ? 'Masculino' : 'Femenino'}
                </span>
                <span className="pacientes-detail-item">
                  <strong>Contacto:</strong> {selectedPaciente.Celular}
                </span>
              </div>
            </div>
            ...
            <form onSubmit={handleHistorialSubmit}>
              <div className="pacientes-form-grid">
                <div className="pacientes-form-group">
                  <label className="pacientes-form-label">
                    <svg className="pacientes-label-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                    </svg>
                    Fecha de Consulta *
                  </label>
                ...
                <div className="pacientes-form-group full-width">
                  ...
                  <textarea 
                    ...
                    onChange={handleHistorialFormChange} 
                    placeholder="Lista de medicamentos prescritos con dosis y frecuencia..."
                    rows="4"
                  />
                </div>
                ...
                <div className="pacientes-form-group full-width">
                  ...
                  <textarea 
                    ...
                    onChange={handleHistorialFormChange} 
                    placeholder="Observaciones adicionales, síntomas, evolución del paciente..."
                    rows="4"
                  />
                </div>
              </div>
